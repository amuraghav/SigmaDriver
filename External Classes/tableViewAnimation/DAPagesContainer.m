...
- (void)setSelectedIndex:(NSUInteger)selectedIndex animated:(BOOL)animated
{
    ...
    NSLog(@"table View No : %d",selectedIndex);
    [[NSUserDefaults standardUserDefaults] setInteger:selectedIndex forKey:@"TableNo"];
...
{
    return CGRectGetMaxY(self.topBar.frame) - 4. + CGRectGetHeight(self.pageIndicatorView.frame) / 2.;
}
