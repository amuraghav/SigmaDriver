...
- (id)init
{
    ...
    if (self) {
        ...
        //  Normal Cell Colors
        _normalBackgroundColor = [UIColor colorWithRed:0.981 green:1.000 blue:0.985 alpha:1.000]; //kCalendarColorLightGray;
        _selectedBackgroundColor = [UIColor colorWithRed:0.722 green:1.000 blue:0.995 alpha:1.000];//kCalendarColorBlue;
        _inactiveSelectedBackgroundColor = kCalendarColorDarkGray;
        
        //  Today Cell Colors
        _todayBackgroundColor = [UIColor colorWithRed:246/255.0 green:206/255.0 blue:18/255.0 alpha:1.0];//kCalendarColorBluishGray;
        _todaySelectedBackgroundColor = [UIColor colorWithRed:36.0/255.0 green:195.0/255.0 blue:155.0/255.0 alpha:1];//kCalendaryellow;
