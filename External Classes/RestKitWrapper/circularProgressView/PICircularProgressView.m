...
- (void)drawRect:(CGRect)rect
{
    ...
    {
       // NSString *progressString = [NSString stringWithFormat:@"%.0f", (_progress * 100.0)/1.66666666];

        NSString *progressString = [NSString stringWithFormat:@"%.0f", (_progress * 100.0)/5.0000000];
